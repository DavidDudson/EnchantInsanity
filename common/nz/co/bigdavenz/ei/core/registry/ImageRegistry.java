...
public class ImageRegistry {
    ...
    public static ImageResource hungerBar = new ImageResource(ResourcePaths.PATH_HUNGER_BAR,403, 14);
    public static ImageResource armourbarBacking = new ImageResource(ResourcePaths.PATH_ARMOURBAR_BACKING,189, 36);
