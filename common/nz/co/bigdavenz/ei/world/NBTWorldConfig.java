...
public class NBTWorldConfig {

    public static File getConfigFolder() {
        return new File(new File(Minecraft.getMinecraft().mcDataDir, "worldConfig"), Reference.MOD_NAME);
    }
    
    public static File getWorldConfig(World world) {
        return new File(getWorldDir(world), Reference.MOD_NAME);
    }
