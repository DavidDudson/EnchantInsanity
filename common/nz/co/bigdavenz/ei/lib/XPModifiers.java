...
public class XPModifiers {
	...
	// Damage Related XP Gain

	public final static int XP_PER_DAMAGE_FALL = 2;
	public final static int XP_PER_DAMAGE_IN_FIRE = 3;
	public final static int XP_PER_DAMAGE_ON_FIRE = 3;
	public final static int XP_PER_DAMAGE_CACTUS = 2;
	public final static int XP_PER_DAMAGE_DROWN = 5;
	public final static int XP_PER_DAMAGE_STARVE = 5;
	public final static int XP_PER_DAMAGE_EXPLOSION_PLAYER = 5;
	public static final int XP_PER_DAMAGE_OUT_OF_WORLD = 5;
	public static final int XP_PER_DAMAGE_GENERIC = 5;
	public static final int XP_PER_DAMAGE_MAGIC = 4;
	public static final int XP_PER_DAMAGE_WITHER = 5;
	public static final int XP_PER_DAMAGE_ANVIL = 4;
	public static final int XP_PER_DAMAGE_FALLING_BLOCK = 3;
	public static final int XP_PER_DAMAGE_IN_WALL = 3;
